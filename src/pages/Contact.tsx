              ...
              {socials.map((social) => {
                ...
                return (
                  <a
                    ...
                    className="glow-card flex items-center gap-3 rounded-xl border border-zinc-800 bg-zinc-900/50 p-4 text-zinc-400 transition-all hover:border-zinc-700 hover:text-white"
                  >
